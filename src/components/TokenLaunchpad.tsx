...
import { CoinsIcon as Coin, Image, Package, Loader2 } from 'lucide-react'
...
export function TokenLaunchpad() {
  ...
  return (
      <Card className="w-full max-w-md bg-purple-700/30 backdrop-blur-md">
        <CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="name" className="text-sm font-medium text-gray-700">Token Name</label>
              <div className="relative">
                <Coin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
                <Input
                  id="name"
                  type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="initialSupply" className="text-sm font-medium text-gray-700">Initial Supply</label>
              <Input
                id="initialSupply"
                type="number"
                placeholder="1000000"
